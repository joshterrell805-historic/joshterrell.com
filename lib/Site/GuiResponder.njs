...
function GuiResponder() {
  ...
  this.addStylesheet('/base/css/global.css');

  this.addScript('url', '//code.jquery.com/jquery-2.1.1.min.js');
  this.addScript('url', '/base/js/jquery-cookie.js');
  ...
  this.addScript('url', '/base/js/TimestampToDate.js');
  this.addScript('url', '/base/js/PageActions.js');
}
...
GuiResponder.prototype.renderPage = function renderPage(pageName, context) {
  ...
  var csrf = this.cookiesToSet_['csrf'] || this.req.cookies.csrf;
  assert(!!csrf);
